---
name: interview
description: "Interview-Briefing für eine Firma: Recherche, typische Fragen, eigene Fragen, Selbstpräsentation; als Interview_Briefing.md im Bewerbungsordner, beim Server gemeldet."
...
Ablauf „Interview“ von Job Radar. Das Skript des Ablaufs liegt auf dem Server und kommt über den Connector; dieser Skill sagt nur, in welcher Reihenfolge es geholt wird und wo die Werkzeuge liegen.
...
2. `.jobradar/ablauf_interview.md` lesen, falls vorhanden; dort steht, wo der letzte Durchlauf stand.
3. `anleitung_laden(thema="interview")` aufrufen und das Skript Schritt für Schritt abarbeiten. Nicht überfliegen, nichts überspringen, Checkpoints des Skripts einhalten.
...
5. Zwischenstand nach `.jobradar/ablauf_interview.md`, wenn der Ablauf über mehrere Sitzungen geht; am Ende aufräumen.
