...
description: Persönliche Anschreiben-Vorlage mit Anker-Pool und Style Guide aus alten Anschreiben und dem Profil. Etwa 45 Minuten, Voraussetzung ist ein Profil.
disable-model-invocation: true
---

# /anschreiben-vorlage

Ablauf „Anschreiben-Vorlage“ von Job Radar. Das Skript des Ablaufs liegt auf dem Server und kommt über den Connector; dieser Skill sagt nur, in welcher Reihenfolge es geholt wird und wo die Werkzeuge liegen.

## Reihenfolge

1. `job_radar_status` aufrufen. Fehlt das Werkzeug oder kommt ein Anmeldefehler: siehe „Verbindung fehlt“, dann abbrechen.
2. `.jobradar/ablauf_anschreiben_vorlage.md` lesen, falls vorhanden; dort steht, wo der letzte Durchlauf stand.
3. `anleitung_laden(thema="anschreiben_vorlage")` aufrufen und das Skript Schritt für Schritt abarbeiten. Nicht überfliegen, nichts überspringen, Checkpoints des Skripts einhalten.
...
5. Zwischenstand nach `.jobradar/ablauf_anschreiben_vorlage.md`, wenn der Ablauf über mehrere Sitzungen geht; am Ende aufräumen.
